...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-gradient-to-r from-primary/10 to-secondary/10 p-1 text-muted-foreground border border-primary/20",
      className,
    )}
    {...props}
  />
